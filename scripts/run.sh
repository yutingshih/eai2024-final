...
run_llama2() {
    ...
    python3 test.py -i $OUTPUT_MODEL -f hf --tokenizer $LLAMA2_MODEL -g 1
}
...
run_llama3() {
    ...
    python3 test.py -i $OUTPUT_MODEL -f hf --tokenizer $LLAMA3_MODEL -g 1
}

python3 test.py -i $LLAMA2_MODEL -f hf --tokenizer $LLAMA2_MODEL -g 1
python3 test.py -i $LLAMA3_MODEL -f hf --tokenizer $LLAMA3_MODEL -g 1
